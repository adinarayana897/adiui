...
(function ($) {
    ...
    $.fn.abigimage.defaults = {
        ...
        prevBtnBoxCSS:        {position: 'absolute', zIndex: 103, top: 134, bottom: 0, left: '68%'},
        closeBtnBoxCSS:       {position: 'absolute', zIndex: 103, top: 134, bottom: 0, right: '68%'},
        ...
        imgCSS:               {position: 'absolute', zIndex: 102, margin: 'auto', width: 'auto',
                                  top: 101, right: 0, bottom: 0, left: 0,
                                  display: 'block', cursor: 'pointer', maxWidth: '32%', maxHeight: '89%'},
