...
$(window).load(function(){
    ...
    jQuery(document).on('ready', function () {
        ...
        jQuery(window).on('scroll', function (event) {
            ...
            if (scroll < 150) {
                jQuery(".cure-sticky").removeClass("sticky");
            } else {
                jQuery(".cure-sticky").addClass("sticky");
            }
        });


        //===== cure team slick slider
        $('.cure-testimonial-slider').slick({
            dots: true,
            infinite: true,
            autoplay: true,
            autoplaySpeed: 2000,
        ...
        //===== cure team slick slider
        $('.cure-testimonial-slider-rtl').slick({
            dots: true,
            infinite: true,
            autoplay: true,
            autoplaySpeed: 2000,
        ...
        //===== cure team slick slider
        $('.cure-testimonial-slider-2').slick({
            dots: false,
            infinite: true,
            autoplay: true,
            autoplaySpeed: 2000,
        ...
        //===== cure VIDEO PLAYER slick slider
        $('.cure-video-player-slider').slick({
            dots: false,
            infinite: true,
            autoplay: true,
            autoplaySpeed: 2000,
       ...
       //===== pricing plan js active
        ...
        jQuery('.cure-video-popup').magnificPopup({
            type: 'iframe'
            // other options
        });
        ...
        jQuery('.cure-image-popup').magnificPopup({
            type: 'image',
            gallery: {
                enabled: true
            }
